...
if __name__ == '__main__':
    ...
    parser.add_argument('--benchmark', type=str, default='pfpascal', choices=['pfpascal', 'pfwillow', 'caltech', 'spair', 'unreal'])
    parser.add_argument('--thres', type=str, default='auto', choices=['auto', 'img', 'bbox'])
    parser.add_argument('--alpha', type=float, default=0.1)
    parser.add_argument('--logpath', type=str, default='')
    parser.add_argument('--bsz', type=int, default=16)  # batch size
    ...
    model.eval()  # switching to Evaluation

    # Dataset download & initialization
    # download.download_dataset(args.datapath, args.benchmark)  # Dataset download from google drive
